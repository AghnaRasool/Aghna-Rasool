...
function check10FirstOrLast(arr) {
  ...
  console.log(check10FirstOrLast(array1)); // Output: "10 appears in the first or last position."
  console.log(check10FirstOrLast(array2)); // Output: "10 appears in the first or last position."
console.log("TASK 8");
function sortStringAlphabetically(inputString) {
  ...
  console.log(sortedResult); // Output: 'acmost'